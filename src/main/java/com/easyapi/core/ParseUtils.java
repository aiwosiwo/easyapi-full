...
public class ParseUtils {
    ...
    public static File searchJavaFile(File inJavaFile, String className) {
        ...
        if (file == null) {
            file = getFileFromCurrentProjectPath(className + JAVA_FILE_SUFFIX);
        }
    ...
    private static File searchJavaFileInner(String javaSrcPath, File inJavaFile, String className) {
        CompilationUnit compilationUnit = getCompilationUnit(inJavaFile);
        ...
        if (cPaths.length == 1) {
            ...
            if (javaFiles != null && javaFiles.length > 0) {
                ...
                if (getInnerClassNode(getCompilationUnit(javaFile), className).isPresent()) {
                    return javaFile;
                }
            }
        }
        ...
        if (cPaths.length > 1) {
            try {
                ...
                if (getInnerClassNode(getCompilationUnit(innerClassFile), cPaths[cPaths.length - 1]).isPresent()) {
    ...
    public static CompilationUnit getCompilationUnit(File javaFile) {
        try {
            ...
            throw new RuntimeException("Error: java file not exits , file path : " + javaFile.getAbsolutePath());
        } catch (Exception e) {
            throw new RuntimeException("Error: parser error , file path : " + javaFile.getAbsolutePath());
        }
    }

    public static void parseClassNodeByType(File inJavaFile, com.easyapi.core.parser.ClassNode rootClassNode, Type classType) {
    ...
    public static void parseClassNode(File modelJavaFile, com.easyapi.core.parser.ClassNode classNode) {
        innerParseClassNode(modelJavaFile, classNode);
    }

    private static void innerParseClassNode(File modelJavaFile, com.easyapi.core.parser.ClassNode classNode) {
        String resultClassName = classNode.getClassName();
        ParseUtils.getCompilationUnit(modelJavaFile).
                ...
                stream().filter(f -> resultClassName.endsWith(f.getNameAsString())).findFirst().ifPresent(cl -> {
                    ...
                    if (!extendClassTypeList.isEmpty()) {
                        ...
                        com.easyapi.core.parser.ClassNode extendClassNode = new com.easyapi.core.parser.ClassNode();
                        List<com.easyapi.core.parser.GenericNode> extendGenericNodes = new ArrayList<>();
                        ...
                        extendClassType.getTypeArguments().ifPresent(typeList -> typeList.forEach(argType -> {
                            com.easyapi.core.parser.GenericNode extendGenericNode = new com.easyapi.core.parser.GenericNode();
                            com.easyapi.core.parser.GenericNode thisGenericNode = classNode.getGenericNode(argType.asString());
                    ...
                    cl.findAll(FieldDeclaration.class)
                            ...
                            .forEach(fd -> {
                                ...
                                fd.getVariables().forEach(field -> {
                                    com.easyapi.core.parser.FieldNode fieldNode = new com.easyapi.core.parser.FieldNode();
                                    ...
                                    fd.getAnnotationByName("RapMock").ifPresent(an -> {
                                        if (an instanceof NormalAnnotationExpr) {
                                            ...
                                            com.easyapi.core.parser.MockNode mockNode = new com.easyapi.core.parser.MockNode();
    ...
    private static void parseFieldNode(com.easyapi.core.parser.FieldNode fieldNode, File inJavaFile, Type fieldType) {

        final com.easyapi.core.parser.GenericNode genericNode = fieldNode.getClassNode().getGenericNode(fieldType.asString());
        ...
        if (genericNode == null && !fieldType.asString().contains("<")) {
            ...
            if (TYPE_MODEL.equals(unifyType(fieldClassType))) {
                ...
                try {
                    ...
                    ed = getCompilationUnit(childJavaFile)
        ...
        if (fieldType.getParentNode().get() instanceof ArrayType) {
            ...
            com.easyapi.core.parser.GenericNode arrayTypeNode = fieldNode.getClassNode().getGenericNode(fieldType.asString());
            ...
            if (isCollectionType(fieldType.asString())) {
                ...
                if (collectionType.isEmpty()) {
                    ...
                    // 是否在泛型列表中
                    com.easyapi.core.parser.GenericNode collectionGenericNode = fieldNode.getClassNode().getGenericNode(collectionType.get(0).asString());
        ...
        if (TYPE_MODEL.equals(unifyType)) {
            ...
            com.easyapi.core.parser.ClassNode childNode = new com.easyapi.core.parser.ClassNode();
            ...
            if (fieldType instanceof ClassOrInterfaceType) {
                ((ClassOrInterfaceType) fieldType).getTypeArguments().ifPresent(typeList -> typeList.forEach(argType -> {
                    com.easyapi.core.parser.GenericNode childClassGenericNode = new com.easyapi.core.parser.GenericNode();

                    if (argType instanceof ArrayType) {
                        com.easyapi.core.parser.GenericNode arrayTypeNode = fieldNode.getClassNode().getGenericNode(((ArrayType) argType).getComponentType().asString());
                        if (arrayTypeNode != null) {
                            ((ArrayType) argType).setComponentType(arrayTypeNode.getClassType());
                        }
                    } else {
                        com.easyapi.core.parser.GenericNode arrayTypeNode = fieldNode.getClassNode().getGenericNode(argType.asString());
                        if (arrayTypeNode != null) {
    ...
    private static boolean inClassDependencyTree(com.easyapi.core.parser.FieldNode fieldNode, com.easyapi.core.parser.ClassNode parentClassNode) {
    ...
    public static boolean isEnum(File inJavaFile, String className) {
        try {
            ...
            return getCompilationUnit(javaFile).getEnumByName(className).isPresent();
        } catch (Exception ex) {
            return false;
        }
    }
    ...
    private static void parseResponseNodeByReflection(File inJavaFile, String className, com.easyapi.core.parser.ClassNode classNode) {

        Class modelClass = getClassInJavaFile(inJavaFile, className);

        if (modelClass != null) {

            if (classNode instanceof com.easyapi.core.parser.ResponseNode) {

                com.easyapi.core.parser.ResponseNode responseNode = (com.easyapi.core.parser.ResponseNode) classNode;
                responseNode.reset();

                // 解析方法返回值泛型信息
                Class controllerClass = ParseUtils.getClassInJavaFile(inJavaFile, inJavaFile.getName().replace(".java", ""));
                if (controllerClass != null) {
                    com.easyapi.core.parser.RequestNode requestNode = responseNode.getRequestNode();
                    try {
                        // 获取该api对应的请求方法
    ...
    public static void parseClassNodeByReflection(com.easyapi.core.parser.ClassNode classNode) {
        ...
        List<com.easyapi.core.parser.FieldNode> childNodes = classNode.getChildNodes();
        ...
        for (Field field : modelClass.getDeclaredFields()) {
            ...
            com.easyapi.core.parser.ClassNode childClassNode = new ClassNode();
            ...
            if (Collection.class.isAssignableFrom(fieldClass)) {
                ...
                if (boxType instanceof ParameterizedType) {  // List<GenericResult<Student[], Integer>> picList
                    ...
                    com.easyapi.core.parser.GenericNode genericNode = classNode.getGenericNode(((TypeVariable) boxType).getName());
                    if (genericNode == null) {
                        continue;
                    } else {
            ...
            if (childNodeClass == null) {
                ...
                if (childGenericType instanceof TypeVariable) {
                    com.easyapi.core.parser.GenericNode genericNode = classNode.getGenericNode(((TypeVariable) childGenericType).getName());
                    if (genericNode == null) {
                        continue;
                    } else {
                    ...
                    for (java.lang.reflect.Type paramType : paramTypes) {
                        if (paramType instanceof TypeVariable) {
                            com.easyapi.core.parser.GenericNode genericNode = classNode.getGenericNode(((TypeVariable) paramType).getName());
                            if (genericNode != null) {
    ...
    public static void parseGenericNodesInType(Class fieldClass, java.lang.reflect.Type fieldGenericType, List<com.easyapi.core.parser.GenericNode> genericNodeList) {
        ...
        if (fieldGenericType instanceof ParameterizedType) {
            ...
            for (java.lang.reflect.Type paramType : paramTypes) {
                com.easyapi.core.parser.GenericNode paramGenericNode = new com.easyapi.core.parser.GenericNode();
                ...
                if (paramType instanceof ParameterizedType) {  // GenericResult<Student, Integer> picList
                    ...
                    if (childTypeArguments != null) {
                        ...
                        List<com.easyapi.core.parser.GenericNode> childGenericNodeList = new ArrayList<>();
                        ...
                        for (java.lang.reflect.Type childGenericType : childTypeArguments) {
                            if (childGenericType instanceof Class) {
                                com.easyapi.core.parser.GenericNode childGenericNode = new com.easyapi.core.parser.GenericNode();
